var Demo = (function () {
  ...
  function create_main_fragment$1(component, ctx) {
  	...
  	component.root._beforecreate.push(function () {
  		tristate._bind({ items: 1 }, tristate.get());
  	});
  ...
  function create_each_block(component, ctx) {
  	...
  	return {
  		c: function create() {
  			...
  			text2 = createText("\r\n        ");
  			toggleClass(i_2, "selected", ctx.item.checked);
  			addLoc(i_2, file$1, 7, 12, 175);
  			addLoc(span, file$1, 8, 12, 226);

  			li._svelte = { component: component, ctx: ctx };

  			addListener(li, "click", click_handler);
  			addLoc(li, file$1, 6, 8, 129);
  		},
